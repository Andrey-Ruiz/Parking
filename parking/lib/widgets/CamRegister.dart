// ignore_for_file: camel_case_types, unnecessary_null_comparison, duplicate_ignore, use_build_context_synchronously
import 'dart:io';
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          return Stack(
            children: [
              if(_isGranted) FutureBuilder <List<CameraDescription>>(
               ...
               Container(child: _isGranted ? Column(children: [Expanded(child: Container()),
               Padding(
...
Future<void> _scan() async {
    ...
    try {
      ...
      await navigator.push(MaterialPageRoute(
        builder: (context) => 
        Register(textv: recognizerText.text),
      ));
    } catch (e) {
